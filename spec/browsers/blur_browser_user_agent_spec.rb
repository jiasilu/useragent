...
describe "UserAgent: 'Blur/1.0.1 (iPhone; OS 9.0.2)'" do
  before do
    @useragent = UserAgent.parse("Blur/1.0.1 (iPhone; OS 9.0.2)")
  end

  it "should return BlurBrowser" do
    expect(@useragent.browser).to eq("Blur Browser")
  end
...
describe "UserAgent: 'Blur/1.0.0 (Android; OS 4.2.2)'" do
  before do
    @useragent = UserAgent.parse("Blur/1.0.0 (Android; OS 4.2.2)")
  end
